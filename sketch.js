...
function draw() {
    ...
    // Filtro 1
    pinkLayer.image(warms, posA_x, posA_y, img.width * 0.5, img.height * 0.5);
    tealLayer.image(cools, posA_x, posA_y, img.width * 0.5, img.height * 0.5);

    // Filtro 2
    scarLayer.image(warms, posB_x, posB_y, img.width * 0.5, img.height * 0.5);
    greenLayer.image(cools, posB_x, posB_y, img.width * 0.5, img.height * 0.5);

    // Filtro 3
    indiLayer.image(warms, posC_x, posC_y, img.width * 0.5, img.height * 0.5);
    redLayer.image(cools, posC_x, posC_y, img.width * 0.5, img.height * 0.5);
